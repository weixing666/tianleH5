<template>
  <div class="goodsdetail">
    ...
    <van-goods-action>
      ...
      <van-goods-action-icon icon="cart-o" text="购物车" :badge="carnum" to="/home/shopping" />
      <van-goods-action-icon icon="shop-o" text="进入店铺" to="/home/index" />
      <van-goods-action-button type="warning" text="加入购物车" @click="onClickButton" />
      <van-goods-action-button type="danger" text="立即购买" @click="onClickButton(false)" />
    </van-goods-action>
    <!-- 加入购物车弹窗 -->
    <van-sku v-model="show" :sku="sku" :goods="goods" :goods-id="info.id" :show-add-cart-btn="showAddCartBtn" @add-cart="addCart">
